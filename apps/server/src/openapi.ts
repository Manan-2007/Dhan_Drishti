...
export const openApiSpec = {
  ...
  components: {
    ...
    schemas: {
      ...
      ImportInput: { type: "object", required: ["portfolioId", "broker", "filename", "content"], properties: { portfolioId: { type: "string" }, accountId: { type: ["string", "null"] }, broker: { type: "string" }, filename: { type: "string" }, content: { type: "string", description: "Raw CSV text" }, mapping: { type: "object", description: "Column mapping (required for the generic adapter)" } } },
